...
resource "aws_glue_crawler" "platform_gc_design_system_airtable" {
  name          = "Platform / GC Design System / Airtable"
  description   = "Classify the GC Design System Airtable export data"
  ...
  s3_target {
    path = "s3://${var.transformed_bucket_name}/platform/gc-design-system/airtable/"
  }
