...
class TestGCDesignSystemExport:
    ...
    def test_handler_success(self, mock_boto3_client, mock_urllib_request, sample_airtable_response):
    ...
    def test_handler_s3_failure(self, mock_boto3_client, mock_urllib_request, sample_airtable_response):
    ...
    def test_fetch_all_records_single_page(self, mock_boto3_client, mock_urllib_request, sample_airtable_response):
    ...
    def test_fetch_all_records_multiple_pages(self, mock_boto3_client, mock_urllib_request):
        ...
        page2_response = {
            "records": [{"id": "rec2", "fields": {"name": "Client 2"}}]
        }
